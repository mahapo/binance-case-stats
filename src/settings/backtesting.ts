...
export const backtestRanges: ParamRange[] = [
  { key: "leverage", start: 25, end: 150, step: 25 }, // 150x (max allowed by Binance)
  { key: "ratio", start: 2, end: 5, step: 1 }, // (TP% = ratio × gap%)
  { key: "gapPercent", start: 20, end: 40, step: 5 }, // 30, 40  ("30% SL", …)
  { key: "maxSteps", start: 4, end: 7, step: 1 }, // 4 .. 6 hedge orders
