...
export const backtestRanges: ParamRange[] = [
  { key: "leverage", start: 50, end: 125, step: 25 }, // 150x (max allowed by Binance)
  ...
  { key: "maxDrawdownPercent", start: 10, end: 50, step: 10 }, // worst-case series loss: 20/30/40%
